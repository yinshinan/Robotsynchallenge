...
__all__ = ["SampleLoadingEnv", "SampleLoadingAgentEnv"]


@register_env("SampleLoading-v1", max_episode_steps=600)
...
@register_env("SampleLoadingAgent-v1", max_episode_steps=600)
