...
# bash finetune.sh /path/to/lerobot_v21_dataset outputs/train/act_click_bell 0 --steps 1000
# ----------------------------------------------------------------------------
...
# For DDP/multi-GPU training, prefer the torchrun command in the ACT docs.
